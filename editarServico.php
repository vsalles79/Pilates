              ...
              <div class="col-sm-6">
                     ...
                     <div class="form-group">
                        <div class="input-group" id="edit-descricao">
                          <input name="descricao" type="text" id="descricao-servico" maxlength="10" class="textBox" placeholder="Descrição" value="<?php echo $dados["descricao"]; ?>"/>
                        </div>
                      </div>

                      <div class="form-group">
                        <div class="input-group">
                          <input name="valor" type="text" id="valor-servico" maxlength="10" class="textBox" placeholder="Valor serviço" value="<?php echo $dados["valor"]; ?>" />
                        </div>
                      </div>
