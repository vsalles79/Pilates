  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12" id="menuTab">
        <a href="home.html" id="btnHome" class="btn btn-info" role="button" title="Home"><i class="fas fa-home"></i></a>
      ...
      <div id="tabs">
        ...
        <ul class="nav nav-tabs">
          <li class="active"><a data-toggle="tab" href="#menu1">Cadastro Funcion&aacute;rio</a></li>
        </ul>
    </div>
